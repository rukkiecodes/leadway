    ...
    <v-img
      :src="
        transaction?.currency == 'Ethereum'
          ...
          : transaction?.currency == 'USDT' ? 'https://res.cloudinary.com/rukkiecodes/image/upload/v1674077441/tether_rmsn0x.png'
          : transaction?.currency == 'BnB' ? 'https://res.cloudinary.com/rukkiecodes/image/upload/v1674077578/binance_cnrt28.png'
